...
playlists = 播放列表
playlist = 播放列表
playlist_create_failed = 无法创建播放列表：{ $error }
playlist_create_unsupported = 此曲目无法保存到当前服务器。
album = 专辑
artist = 艺术家
home = 首页
search = 搜索
...
add_server = 添加服务器
connect_to_lastfm = 连接到 Last.fm
lastfm_connected = 已连接到 Last.fm
...
yt_syncing_progress = 同步中 — 已加载 { $count } 首曲目
yt_synced_total = 已同步 { $count } 首喜爱的曲目
refresh = 刷新
...
sample_rate = 采样率
bitrate = 比特率
musicbrainz_release = MusicBrainz 发行
musicbrainz_recording = MusicBrainz 录音
musicbrainz_track = MusicBrainz 音轨
path = 路径
add_photo = 添加图片
change_photo = 更换图片
remove_photo = 移除图片
