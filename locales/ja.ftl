...
playlists = プレイリスト
playlist = プレイリスト
playlist_create_failed = プレイリストを作成できませんでした: { $error }
playlist_create_unsupported = この曲はアクティブなサーバーに保存できません。
album = アルバム
artist = アーティスト
home = ホーム
search = 検索
...
add_server = サーバーを追加
connect_to_lastfm = Last.fm に接続
lastfm_connected = Last.fm 接続済み
...
yt_syncing_progress = 同期中 — これまでに { $count } 曲を読み込みました
yt_synced_total = お気に入りの { $count } 曲を同期しました
refresh = 更新
...
sample_rate = サンプルレート
bitrate = ビットレート
musicbrainz_release = MusicBrainz リリース
musicbrainz_recording = MusicBrainz レコーディング
musicbrainz_track = MusicBrainz トラック
path = パス
add_photo = 写真を追加
change_photo = 写真を変更
remove_photo = 写真を削除
