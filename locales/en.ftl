...
playlists = Playlists
playlist = Playlist
playlist_create_failed = Could not create the playlist: { $error }
playlist_create_unsupported = This track can't be stored on the active server.
album = Album
artist = Artist
home = Home
search = Search
...
spotify_url_hint = Paste a public Spotify playlist or album link — the full track list is imported. No login needed.
