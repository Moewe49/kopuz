...
playlist = Playlist
playlist_create_failed = Playlistul nu a putut fi creat: { $error }
playlist_create_unsupported = Această piesă nu poate fi salvată pe serverul activ.
album = Album
artist = Artist
home = Acasă
search = Căutare
...
# YT auto-refresh
yt_auto_refresh_label = Rămâi conectat automat — recitește cookie-urile dintr-un browser conectat la pornire (ține YouTube deschis în Firefox; fără F12).
