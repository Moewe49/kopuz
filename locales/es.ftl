...
playlist_create_failed = No se pudo crear la lista de reproducción: { $error }
playlist_create_unsupported = Esta pista no se puede guardar en el servidor activo.
album = Álbum
artist = Artista
home = Inicio
search = Buscar
...
spotify_url_hint = Pega un enlace público de lista o álbum de Spotify: se importa la lista completa de pistas. No hace falta iniciar sesión.
