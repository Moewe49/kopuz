...
playlists = Playlists
playlist = Playlist
playlist_create_failed = Playlist konnte nicht erstellt werden: { $error }
playlist_create_unsupported = Dieser Titel kann auf dem aktiven Server nicht gespeichert werden.
album = Album
artist = Künstler
home = Start
search = Suchen
...
spotify_url_hint = Füge einen öffentlichen Spotify-Playlist- oder Album-Link ein — die vollständige Titelliste wird importiert. Kein Login nötig.
