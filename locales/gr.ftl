...
playlist_create_failed = Δεν ήταν δυνατή η δημιουργία της λίστας: { $error }
playlist_create_unsupported = Αυτό το κομμάτι δεν μπορεί να αποθηκευτεί στον ενεργό διακομιστή.
album = Άλμπουμ
artist = Καλλιτέχνης
home = Αρχική
search = Αναζήτηση
