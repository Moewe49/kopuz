...
playlists = Плейлисты
playlist = Плейлист
playlist_create_failed = Не удалось создать плейлист: { $error }
playlist_create_unsupported = Этот трек нельзя сохранить на активном сервере.
album = Альбом
artist = Артист
home = Главная
search = Поиск
...
no_saved_servers = Нет сохранённых серверов
jellyfin = Jellyfin
subsonic = Subsonic
...
radio_asiadreamradio_desc = Сердце Джей-поп музыки - Джей-поп, Джей-рок, Джей-хип-хоп, Джей-джаз, классика.
...
# Radio Registries
radio_registry_url_placeholder = URL или локальный путь к index.json
...
radio_registry_enable_failed = Не удалось включить реестр: { $error }
radio_registries_active = { $enabled_count }/{ $total } активно
radio_registries_empty = Реестры не настроены
...
spotify_creating = Создание плейлиста в вашем аккаунте YouTube Music…
spotify_adding = Добавление треков — { $done } / { $total }
spotify_done = Импортировано { $matched } из { $total } треков. Плейлист теперь в вашей библиотеке YouTube Music.
...
yt_auth_browser = Войти через браузер
yt_auth_paste = Вставить cookies (работает на Windows)
yt_auth_anonymous = Продолжить без входа (анонимно)
yt_anon_explainer = kopuz будет использовать YouTube Music без входа. Можно просматривать, искать и слушать — но любимые треки, плейлисты библиотеки и подписки/лайки недоступны.
yt_paste_step1 = Откройте music.youtube.com в браузере и войдите.
yt_paste_step2 = Нажмите F12 → вкладка «Сеть» → перезагрузите → кликните любой запрос music.youtube.com.
yt_paste_step3 = В заголовках запроса скопируйте полное значение Cookie и вставьте ниже.
yt_paste_firefox = Импорт из Firefox
yt_paste_firefox_hint = Читает вашу сессию YouTube напрямую из Firefox/LibreWolf.
yt_paste_invalid = YouTube отклонил эти cookies — скопируйте полный заголовок Cookie из вкладки music.youtube.com, где выполнен вход.
yt_manual_session_expired = Сессия YouTube Music истекла. Вставьте свежие cookies: Настройки → Медиасерверы → заново добавьте YouTube Music.

# SoundCloud search
soundcloud_searching = Поиск…
soundcloud_search_for = Искать «{ $query }» на SoundCloud
soundcloud_download = Скачать через yt-dlp

# SoundCloud view + unified search
soundcloud_hint = Введите запрос выше, чтобы искать на SoundCloud.
soundcloud_needs_ytdlp = Для поиска в SoundCloud нужен установленный yt-dlp.
...
discord_test = Проверить подключение к Discord
discord_test_button = Отправить тест
download_all_offline = Скачать всё для офлайн-прослушивания
download_folder = Папка загрузок
onboarding_title = Добро пожаловать в Kopuz
onboarding_subtitle = Два способа наполнить его музыкой:
onboarding_local_title = Локальная папка с музыкой
onboarding_local_desc = Укажите Kopuz папку с аудиофайлами, чтобы просматривать и слушать их.
onboarding_stream_title = YouTube Music или сервер
onboarding_stream_desc = Подключите YouTube Music (или Jellyfin / Subsonic), чтобы слушать и скачивать.
onboarding_open_settings = Открыть настройки
onboarding_later = Может быть позже
premium_downloads = Premium-загрузки (256 кбит/с)
premium_downloads_hint = Входит в аккаунт, чтобы получать AAC 256 кбит/с. Помогает только аккаунтам YouTube Premium; при высокой нагрузке изредка может вызвать проверку на бота. Выключено = анонимные 128 кбит/с.
remove_downloads = Удалить загрузки
reset_to_default = Сбросить по умолчанию
search_elsewhere = В { $source } ничего — в других источниках есть:
